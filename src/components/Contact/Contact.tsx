    ...
    >
      ...
      <div data-aos='fade-left' className='mt-12'>
        <a
          ...
          className='inline-block rounded-[5px] border-2 border-pry bg-transparent px-4 py-2 text-pry transition-all duration-1000 ease-in-out hover:scale-110 hover:border-transparent hover:bg-pry hover:text-black hover:shadow-glow cursor-pointer'
        >
          {' '}
          Say Hello{' '}
        </a>
